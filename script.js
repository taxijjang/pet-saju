...
const breedCatalog = {
  ...
  cat: [
    ...
    },
    {
      ...
      label: "브리티시 숏헤어",
      vibe: "동글고 차분한 존재감이 큰",
      personality: "묵직한 안정감과 느긋한 표정으로 집안 공기를 부드럽게 눌러주는 편이에요.",
      social: "무리하게 다가오기보다 자연스럽게 곁을 채워주는 사람에게 더 마음을 열어요.",
      routine: "익숙한 자리, 정돈된 루틴, 조용한 놀이가 이어질수록 만족도가 높아져요.",
      care: "갑작스러운 변화보다 천천히 예고된 일상 안에서 컨디션이 가장 안정됩니다."
    },
    {
      value: "munchkin",
      group: "대표 묘종",
      label: "먼치킨",
      vibe: "통통 튀는 장난기가 매력인",
      personality: "작고 귀여운 움직임 안에 호기심과 생활 센스가 알차게 들어 있는 편이에요.",
      social: "재미있는 장난감이나 반응을 잘 받아주는 집사와 빠르게 친해져요.",
      routine: "짧고 잦은 놀이, 낮은 높이의 탐색, 포근한 쉬는 자리가 균형 있게 필요해요.",
      care: "몸에 무리가 가지 않는 범위에서 자주 놀 수 있게 템포를 잘 나눠주는 게 중요해요."
    },
    {
      value: "norwegian-forest",
      group: "대표 묘종",
      label: "노르웨이 숲",
      vibe: "숲속 같은 여유와 품이 있는",
      personality: "차분하지만 탐색 본능이 살아 있어 넓고 입체적인 공간에서 매력이 더 선명해져요.",
      social: "믿을 만한 존재라고 느끼면 조용하고 깊은 애착을 보여주는 편이에요.",
      routine: "오르내릴 수 있는 동선과 혼자 쉬는 시간, 느긋한 놀이가 함께 있는 흐름이 잘 맞아요.",
      care: "자기만의 영역을 충분히 보장해주면 마음이 훨씬 부드럽게 열립니다."
    },
    {
      value: "maine-coon",
      group: "대표 묘종",
      label: "메인쿤",
      vibe: "든든하고 유쾌한 대형묘의 여유",
      personality: "체구는 크지만 성격은 다정하고 넉넉해서 존재만으로도 안정감을 주는 편이에요.",
      social: "가족 곁에 조용히 함께 있는 시간을 좋아하고, 익숙한 사람과의 교감을 오래 기억해요.",
      routine: "넓게 걷고 천천히 노는 시간, 푹 쉴 수 있는 큰 자리가 함께 있을 때 만족도가 높아요.",
      care: "큰 체구에 맞는 여유로운 공간과 무리하지 않는 놀이 템포를 챙겨주면 좋아요."
    },
    {
      value: "siamese",
      group: "대표 묘종",
      label: "샴",
      vibe: "표현력과 존재감이 또렷한",
      personality: "감정 표현이 풍부하고 집사의 반응에 빠르게 호응하는 스타일이라 교감이 뚜렷해요.",
      social: "말 걸 듯 반응해주고 리액션을 돌려주는 집사와 특히 호흡이 잘 맞아요.",
      routine: "적당한 대화감, 놀이, 관찰 시간이 고르게 섞일수록 에너지가 예쁘게 유지돼요.",
      care: "심심함을 오래 두기보다 자주 반응해주고 관심을 돌려주는 흐름이 필요해요."
    },
    {
      ...
      label: "터키시 앙고라",
      vibe: "가볍고 우아한 기운이 맑은",
      personality: "가벼운 발걸음과 또렷한 눈빛처럼 섬세하면서도 당찬 분위기가 매력으로 보여요.",
      social: "좋아하는 사람에게는 생각보다 적극적으로 다가오며 애정을 표현하는 편이에요.",
      routine: "밝은 곳에서의 탐색, 높은 자리 관찰, 깔끔한 휴식 공간이 잘 어울려요.",
      care: "쾌적한 환경과 예민함을 건드리지 않는 부드러운 접근이 컨디션 유지에 도움이 됩니다."
    },
    {
      value: "abyssinian",
      group: "대표 묘종",
      label: "아비시니안",
      vibe: "재빠른 호기심과 활기가 선명한",
      personality: "몸을 쓰며 배우는 타입이라 움직임과 탐색 안에서 매력이 가장 크게 살아나요.",
      social: "재미있는 놀이를 함께하는 집사에게 신뢰와 애정이 빠르게 붙는 편이에요.",
      routine: "짧고 역동적인 놀이, 캣타워 이동, 새로운 자극이 자주 있는 패턴을 좋아해요.",
      care: "지루함이 길어지지 않도록 환경 자극을 조금씩 바꿔주는 것이 중요합니다."
    },
    {
      value: "exotic-shorthair",
      group: "대표 묘종",
      label: "엑조틱 숏헤어",
      vibe: "폭신하고 느긋한 귀여움이 큰",
      personality: "둥글고 순한 인상처럼 감정선도 부드러워서 편안한 분위기를 오래 좋아하는 편이에요.",
      social: "과한 표현보다 조용하고 꾸준한 애정 속에서 마음이 천천히 열려요.",
      routine: "낮잠, 느린 놀이, 포근한 쉼터가 반복되는 안정적인 하루 패턴이 잘 맞아요.",
      care: "무리하게 텐션을 올리기보다 쉬는 흐름을 지켜주면 특유의 귀여움이 더 잘 살아나요."
    },
    {
      value: "mixed-cat",
      group: "믹스/기타",
